...
const createClient = function (options) {
    return (0, runtime_1.createClient)(Object.assign(Object.assign({ url: 'https://data.loathers.net/graphql' }, options), { queryRoot: typeMap.Query, mutationRoot: typeMap.Mutation, subscriptionRoot: typeMap.Subscription }));
};
