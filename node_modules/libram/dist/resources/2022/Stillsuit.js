 ...
 */
export function distillateAdventures() {
    if (!have())
        return 0;
 ...
 */
export function drinkDistillate() {
    if (!have() || get("familiarSweat") <= 0)
        return false;
    return cliExecute("drink stillsuit distillate");
}
const distillateModifiers = (pref) => parseModifiers(pref);
/**
 * @returns A `Modifiers` object that contains your next Distillate modifiers
 */
export function nextDistillateModifiers() {
 ...
 */
export function currentDistillateModifiers() {
 ...
 */
export function distillateModifier(modifier) {
    visitUrl("inventory.php?action=distill&pwd");
