 ...
 */
export function ingredientsUnlocked() {
 ...
 */
export function fill(...ingredients) {
    if (refillsRemaining() <= 0)
        return false;
    if (new Set(ingredients).size < 3)
        return false;
    if (ingredients.some((i) => !ingredientsUnlocked().includes(i)))
        return false;
 ...
 */
export function modifierOf(ingredient) {
 ...
 */
export function locationOf(ingredient) {
