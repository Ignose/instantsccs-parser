...
import { familiarEquipment, refreshStatus, toInt, visitUrl, } from "kolmafia";
...
export function transform(fam) {
    ...
    if (!have_(equipment))
        return false;
    visitUrl(`inv_equip.php?which=2&action=equip&whichitem=${toInt(equipment)}&pwd`);
    refreshStatus();
    if (currentFamiliar() !== fam) {
        return false;
    }
 ...
 */
export function currentFamiliar() {
