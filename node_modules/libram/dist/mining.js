 ...
 */
export function hasObjectDetection(mine = Mine.ITZNOTYERZITZ) {
    if (mine === Mine.CRIMBONIUM && have($effect `Crimbonar`))
        return true;
    return (haveEffect($effect `Object Detection`) !== 0 ||
 ...
 */
export function caveInCost(mine) {
    switch (mine) {
 ...
 */
export const stateIndexToCoord = (position) => {
...
const getAccessibleSparklesForIndex = (state, index) => {
 ...
 */
export function getAccessibleSparkles(mine) {
 ...
 */
export function minedSpots(mine) {
 ...
 */
export function findNewCavern(mine) {
 ...
 */
export function mineCoordinate(mine, [col, row]) {
 ...
 */
export function getAsMatrix(mine) {
...
export function countFreeMines() {
    return ((have($skill `Unaccompanied Miner`)
