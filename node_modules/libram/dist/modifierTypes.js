...
export const stringModifiersSet = new Set(stringModifiers);
...
export const booleanModifiersSet = new Set(booleanModifiers);
...
export const numericModifiersSet = new Set(numericModifiers);
