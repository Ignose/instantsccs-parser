import { $location, $skill, ensureEffect, get, have, isSong, PropertiesManager, set, undelay, uneffect, } from "libram";
import { adv1, buy, choiceFollowsFight, cliExecute, equippedAmount, fileToBuffer, getRelated, inMultiFight, itemAmount, Location, logprint, myEffects, print, readCcs, retrieveItem, runChoice, runCombat, setAutoAttack, setLocation, toEffect, toLocation, writeCcs, } from "kolmafia";
...
export class ContextualEngine {
     ...
     */
    run(actions) {
        for (let i = 0; i < (actions !== null && actions !== void 0 ? actions : Infinity); i++) {
    ...
    available(task) {
        var _a, _b;
        if (((_a = task.limit) === null || _a === void 0 ? void 0 : _a.skip) !== undefined && this.attempts[task.name] >= task.limit.skip)
            return false;
        ...
        if (task.ready && !task.ready(this.getContext(task)))
            return false;
    ...
    execute(task) {
        ...
        const postcondition = (_b = (_a = task.limit) === null || _a === void 0 ? void 0 : _a.guard) === null || _b === void 0 ? void 0 : _b.call(_a, this.getContext(task));
        ...
        const task_combat = (_d = (_c = task.combat) === null || _c === void 0 ? void 0 : _c.clone()) !== null && _d !== void 0 ? _d : new CombatStrategy();
    ...
    acquireEffects(task) {
        var _a;
        const effects = (_a = undelay(task.effects, this.getContext(task))) !== null && _a !== void 0 ? _a : [];
    ...
    setChoices(task, manager) {
        var _a;
        for (const [key, value] of Object.entries(undelay((_a = task.choices) !== null && _a !== void 0 ? _a : {}, this.getContext(task)))) {
            if (value === undefined)
                continue;
     ...
     */
    setCombat(task, task_combat, task_resources) {
        var _a;
        // Save regular combat macro
        const macro = task_combat.compile(task_resources, (_a = this.options) === null || _a === void 0 ? void 0 : _a.combat_defaults, task.do instanceof Location ? task.do : undefined, this.getContext(task));
        macro.save();
        if (!this.options.ccs) {
     ...
     */
    checkLimits(task, postcondition) {
        var _a;
        if (!task.limit)
            return;
        ...
        if (!task.completed(this.getContext(task))) {
            ...
            if (task.limit.unready && ((_a = task.ready) === null || _a === void 0 ? void 0 : _a.call(task, this.getContext(task))))
    ...
    initPropertiesManager(manager) {
        ...
        if (this.options.ccs !== "") {
            ...
            manager.set({ customCombatScript: (_a = this.options.ccs) !== null && _a !== void 0 ? _a : grimoireCCS });
        }
    }
}
...
export class Engine extends ContextualEngine {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    getContext(task) {
        return;
    }
}
export function maxSongs() {
...
export const environmentSpecificNCs = new Map([
...
export const zoneSpecificNCs = new Map(Object.entries(fileToBuffer("data/encounters.txt")
    .split("\n")
    .reduce((obj, line) => {
    var _a;
    const [location, type, name] = line.split("\t");
    if (type !== "TURTLE" || location === "*")
        return obj;
    return { ...obj, [name]: [...((_a = obj[name]) !== null && _a !== void 0 ? _a : []), toLocation(location)] };
}, {})));
/**
...
export function lastEncounterWasWanderingNC() {
    ...
    if (zoneSpecificNCs.has(last)) {
        ...
        const zones = (_a = zoneSpecificNCs.get(last)) !== null && _a !== void 0 ? _a : [];
        ...
        if (environment === ((_c = get("lastAdventure")) === null || _c === void 0 ? void 0 : _c.environment))
            return true;
